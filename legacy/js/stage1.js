...
function initFragments() {
  fragments = [
    { x: 680,  y: groundY - 150, word: WORDS[0], collected: false, bob: 0 },
    { x: 1380, y: groundY - 175, word: WORDS[1], collected: false, bob: 1 },
    { x: 2550, y: groundY - 160, word: WORDS[2], collected: false, bob: 2 },
  ];
}
initFragments();
...
// initial loop (for title screen snow)
requestAnimationFrame(gameLoop);
